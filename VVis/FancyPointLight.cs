...
namespace VVis
{
    public sealed class FancyPointLight : XamlLight
    {        
        ...
        protected override void OnConnected(UIElement newElement)
        {
            ...
            var light = Window.Current.Compositor.CreatePointLight();
            light.Color = Colors.Blue;
            light.Offset = new System.Numerics.Vector3(100, 300, 200); //z = radius

            var linear = Window.Current.Compositor.CreateLinearEasingFunction();
            ColorKeyFrameAnimation colorAnimation = Window.Current.Compositor.CreateColorKeyFrameAnimation();
            colorAnimation.InsertKeyFrame(0f, Colors.Orange, linear);
            colorAnimation.InsertKeyFrame(.35f, Colors.Red, linear);
            colorAnimation.InsertKeyFrame(.7f, Colors.Yellow, linear);
            colorAnimation.InsertKeyFrame(1f, Colors.Orange, linear);
            ...
            light.StartAnimation("Color", colorAnimation);
        ...
        private static string GetIdStatic()
        {
            ...
            return typeof(FancyPointLight).FullName;
        }
    }
}
